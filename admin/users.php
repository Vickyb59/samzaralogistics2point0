        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <a href="#msg_all" data-toggle="modal" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-envelope"></i> Message all Workers</a>
            </div>
            <div class="box-body">
...
function getRow(id){
  $.ajax({
    ...
    success: function(response){
      ...
      $('#edit_application_status').val(response.application_status);
      $('#edit_visa_status').val(response.visa_status);
      $('#edit_office_addr').val(response.office_addr);
      $('#edit_salary').val(response.salary);
      $('#edit_start_date').val(response.start_date);
      $('#edit_passport_id').val(response.passport_id);
      $('#edit_flight_ticket').val(response.flight_ticket);
      $('#edit_perm_lc').val(response.perm_lc);
      $('#edit_green_card').val(response.green_card);
      $('.fullname').html(response.full_name);
      CKEDITOR.instances["editor2"].setData(response.company_message);
    }
  });
}
</script>
