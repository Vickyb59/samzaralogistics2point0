      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <?php
                $stmt = $conn->prepare("SELECT *, COUNT(*) AS numrows FROM users WHERE type=0 && status=0");
                $stmt->execute();
                $arow =  $stmt->fetch();

                echo "<h3>".$arow['numrows']."</h3>";
              ?>
              <p>New Applicants</p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <?php
                $stmt = $conn->prepare("SELECT *, COUNT(*) AS numrows FROM jobs");
                $stmt->execute();
                $jrow =  $stmt->fetch();

                echo "<h3>".$jrow['numrows']."</h3>";
              ?>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <?php
                $stmt = $conn->prepare("SELECT *, COUNT(*) AS numrows FROM tracking");
                $stmt->execute();
                $trow =  $stmt->fetch();

                echo "<h3>".$trow['numrows']."</h3>";
              ?>
