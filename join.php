<?php
    ...
    if ((isset($_GET["appId"]) && !empty(trim($_GET["appId"]))) && (isset($_GET["pst"]) && !empty(trim($_GET["pst"])))) {
      $applicationId = $_GET["appId"];
      $post = base64_decode($_GET["pst"]);
    }

    $page_name = 'Join Us';
    $banner_name = 'Start Your Journey';
                        ...
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2 contact-form">
                                <div class="calculate-form">
                                    ...
                                    <form class="row" id="contact-form" method="post" action="join_helper.php">
                                        ...
                                        <div class="form-group wow fadeInUp" data-wow-offset="50" data-wow-delay=".30s">
                                            ...
                                            <div class="col-sm-9"> <input type="text" name="email" id="Email" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" placeholder="Enter Your Accessible Email Address" class="form-control"> </div>
                                        </div>
                                        <div class="form-group wow fadeInUp" data-wow-offset="50" data-wow-delay=".30s">
                                        ...
                                        <div class="form-group wow fadeInUp" data-wow-offset="50" data-wow-delay=".30s">
                                            <div class="col-sm-3"> <label class="title-2"> Post Applied For: </label></div>
                                            <div class="col-sm-9"> <input type="text" name="career" id="Name" required placeholder="Career Path*" <?= isset($post) ? "readonly" : ""; ?> value="<?= isset($post) ? $post : '' ?>" class="form-control"> </div>
                                        </div>
                                        <div class="form-group wow fadeInUp" data-wow-offset="50" data-wow-delay=".30s">
